  ...
  en: {
    translation: {
      ...
      avlFixer: {
        ...
        builder: "Builder",
        fixer: "Fixer",
        buildUnbalanced: "Build Unbalanced BST",
        nextStep: "Next Step",
        play: "Auto Play",
        pause: "Pause",
        reset: "Reset",
        balanced: "Tree is balanced!",
        fixerDesc: "Build an unbalanced BST, then watch it get fixed step by step with animations.",
        stepN: "Step",
      },
      breadcrumb: {
        home: "Home",
  ...
  ar: {
    translation: {
      ...
      avlFixer: {
        ...
        builder: "البناء",
        fixer: "المُصلح",
        buildUnbalanced: "بناء BST غير متوازن",
        nextStep: "الخطوة التالية",
        play: "تشغيل تلقائي",
        pause: "إيقاف",
        reset: "إعادة تعيين",
        balanced: "الشجرة متوازنة!",
        fixerDesc: "ابنِ شجرة BST غير متوازنة، ثم شاهدها تُصلَح خطوة بخطوة مع الأنيميشن.",
        stepN: "خطوة",
      },
      breadcrumb: {
        home: "الرئيسية",
